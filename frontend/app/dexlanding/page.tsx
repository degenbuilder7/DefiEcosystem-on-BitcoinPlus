      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <div className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Decentralized Trading on BTCPlus
                  </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <div className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  BTCPlus DEX offers a seamless and secure trading experience, with features like token swapping,
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="grid gap-1">
                  ...
                  <p className="text-muted-foreground">
                    Easily swap any token on the BTCPlus network. Our decentralized exchange ensures fast, secure, and
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                <div className="grid gap-1">
                  ...
                  <p className="text-muted-foreground">
                    Add or remove liquidity to the BTCPlus DEX, earning rewards for providing market depth and stability.
                  </p>
                </div>
              </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm">BTCPlus DEX</div>
                <div className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Explore Our Token Pairs and Liquidity
                </div>
                <div className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Check out the latest token pairs, trading volume, and liquidity on the BTCPlus DEX.
                </div>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
